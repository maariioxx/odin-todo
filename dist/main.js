...
function editToDo(e){
    ...
    if(confirmButton){
        ...
        toDoTitle.textContent = _todos_js__WEBPACK_IMPORTED_MODULE_0__.myToDos[toDoIndex].title;
        ...
        toDoDueDate.textContent = date_fns__WEBPACK_IMPORTED_MODULE_2__["default"](new Date(_todos_js__WEBPACK_IMPORTED_MODULE_0__.myToDos[toDoIndex].dueDate), 'dd-MM-yy');
...
function displayUsername(){
    console.log(_index_js__WEBPACK_IMPORTED_MODULE_1__.username)
