...
body{
    ...
    color: white;
}`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;IACI,gBAAgB;AACpB;;AAEA;IACI,yBAAyB;IACzB,YAAY;AAChB","sourcesContent":[":root{\r\n    font-size: 62.5%;\r\n}\r\n\r\nbody{\r\n    background-color: #191919;\r\n    color: white;\r\n}"],"sourceRoot":""}]);
// Exports
...
function pushToDo(title, description, dueDate, priority, project){
...
function addToDo(){
    ...
    _todos_js__WEBPACK_IMPORTED_MODULE_1__.pushToDo(toDoTitleInput, descInput, dateInput, priorityInput, projectInput);
...
function changeInfoDialog(e){
    ...
    if(e.target && e.target.matches(".toDoTitleBtn")){
        ...
        infoDescription.textContent = `${_todos_js__WEBPACK_IMPORTED_MODULE_1__.myToDos[toDoId].description}`;
