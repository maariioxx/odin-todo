...
#toDoTitle, #dueDate, #editToDoTitle, #editToDoDueDate{
...
div.edit-todo, div.delete-todo, div.confirm-change-todo, div.cancel-change-todo{
    width: 30px;
    cursor: pointer;
    outline: none;
    border-radius: 5px;
...
/* harmony import */ var _projecttodos_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./projecttodos.js */ "./src/projecttodos.js");
...
function displayToDos(){
    _todos_js__WEBPACK_IMPORTED_MODULE_1__.myToDos.map(todo => {
        let toDoId = _todos_js__WEBPACK_IMPORTED_MODULE_1__.myToDos.indexOf(todo)
        if(!(ul.querySelector(`#TD${toDoId}`))){
            ...
            dueDate.textContent = `${date_fns__WEBPACK_IMPORTED_MODULE_4__["default"](new Date(todo.dueDate), 'dd-MM-yy')}`;
            console.log(_todos_js__WEBPACK_IMPORTED_MODULE_1__.myToDos)
...
function editToDo(e){
    ...
    if(confirmButton){
        ...
        _todos_js__WEBPACK_IMPORTED_MODULE_1__.myToDos[toDoIndex].title = parentToDo.querySelector("#editToDoTitle").value;
        toDoTitle.textContent = _todos_js__WEBPACK_IMPORTED_MODULE_1__.myToDos[toDoIndex].title;
        toDoTitle.hidden = false;
        _todos_js__WEBPACK_IMPORTED_MODULE_1__.myToDos[toDoIndex].dueDate = parentToDo.querySelector("#editToDoDueDate").value;
        toDoDueDate.textContent = date_fns__WEBPACK_IMPORTED_MODULE_4__["default"](new Date(_todos_js__WEBPACK_IMPORTED_MODULE_1__.myToDos[toDoIndex].dueDate), 'dd-MM-yy');
        toDoDueDate.hidden = false;
        _todos_js__WEBPACK_IMPORTED_MODULE_1__.myToDos[toDoIndex].priority = parentToDo.querySelector(".priority").id.split("-")[0];
...
function displayProjects(){
    _projects_js__WEBPACK_IMPORTED_MODULE_2__.myProjects.map(project => {
        let projectId = `P${_projects_js__WEBPACK_IMPORTED_MODULE_2__.myProjects.indexOf(project)}`;
...
function addToDo(){
    ...
    let toDoId = _todos_js__WEBPACK_IMPORTED_MODULE_1__.myToDos.length;
    console.log(dateInput)
    _todos_js__WEBPACK_IMPORTED_MODULE_1__.pushToDo(toDoTitleInput, dateInput, priorityInput, projectInput, toDoId);
};

function addProject(){
    let projectTitle = document.querySelector("#projectTitle").value;
    addProjectToSelect(projectTitle);
    _projects_js__WEBPACK_IMPORTED_MODULE_2__.pushProject(projectTitle);
}
...
function deleteToDo(e){
    ...
    const index = _todos_js__WEBPACK_IMPORTED_MODULE_1__.myToDos[(e.target.parentNode.id).split("")[2]];
    _todos_js__WEBPACK_IMPORTED_MODULE_1__.myToDos.splice(index, 1);
    e.target.parentElement.parentElement.remove();
    let currIndex = 0;
    li.forEach(ul => {
        if(ul.id.split("")[2] != e.target.parentElement.parentElement.id.split("")[2]){
            currIndex++;
            let currID = `TD${_todos_js__WEBPACK_IMPORTED_MODULE_1__.myToDos.length - (_todos_js__WEBPACK_IMPORTED_MODULE_1__.myToDos.length - currIndex + 1)}`
...
function createNewProject(){
    ...
    if(input.value.length > 0){
        _projects_js__WEBPACK_IMPORTED_MODULE_2__.pushProject(input.value);
    }
}
...
document.addEventListener("click", (e) => {
    ...
    if(projectTitleBtn){
        _projecttodos_js__WEBPACK_IMPORTED_MODULE_3__.changeAddToDoToProjectTitle(e.target.textContent);
        _projecttodos_js__WEBPACK_IMPORTED_MODULE_3__.deleteNonProjectToDos(e.target.textContent)
    }
})
